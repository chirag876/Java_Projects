...
public class Sender implements ActionListener{
    ...
    Sender()
    {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Icons/Krishna.png"));
        ...
        JLabel name = new JLabel("God");
        name.setBounds(110, 15, 100, 18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SANS_SERIF", Font.BOLD, 18));
        p1.add(name);
        
        JLabel Status = new JLabel("Always Active");
        ...
        JButton send = new JButton("Send Blessings");
        send.setBounds(320, 655, 123, 40);
        send.setBackground(new Color(7,94,84));
        send.setForeground(Color.WHITE);
        send.addActionListener(this);
        send.setFont(new Font("SANS_SERIF", Font.BOLD, 12));
        f.add(send);
